...
Looking at the results, we were surprised by the contribution of RAM stocks to the total potential increase in food production from MPAs, and by the amount of MPAs providing high food increases in areas with heavy RAM coverage. In looking into this question, we feel we may have discovered a problem with the way that the BAU policy is working for RAM stocks. 
